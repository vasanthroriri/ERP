...
$response = ['success' => false, 'message' => ''];
    ...
    if (isset($_POST['hdnAction']) && $_POST['hdnAction'] == 'addStudent') {
        ...
        if ($conn->query($empuser_sql) === TRUE) {
            ...
            $url = "http://erp.inforiya.in/RoririSoftware/studentDetail.php?id=$last_insert_id";
            ...
            try {
                ...
                if (file_exists($qr_file_path)) {
                    ...
                    if ($conn->query($stud_sql) === TRUE) {
                        ...
                        $addStu="INSERT INTO `student_additional_details`(`basic_id`, `college_course`, `course_fee`, `aadhar_no`,`duration`) VALUES ('$last_insert_id','$course','$courseFee','$aadhar','$duration')";
