				...
				<nav class="navbar navbar-expand gap-3">
								...
								<div class="dropdown-menu dropdown-menu-end p-0">
									<div class="app-container p-2 my-2">
									  <div class="row gx-0 gy-2 row-cols-2 justify-content-center p-2">
										 <div class="col">
										  <a href="RoririSoftware/index.php">
											<div class="app-box text-center">
											  <div class="app-icon">
												  <img src="../assets/images/app/slack.png" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">RORIRI</p>
											  </div>
											  </div>
											</a>
										 </div>
										 <div class="col">
										  <a href="NexGen_IT_Academy/index.php">
											<div class="app-box text-center">
											  ...
											  <div class="app-name">
												  <p class="mb-0 mt-1">IT ACADEMY</p>
											  </div>
											  </div>
										  </a>
										 </div>
										 <div class="col">
										  <a href="NexGen_IT_College/index.php">
											<div class="app-box text-center">
											  <div class="app-icon">
												<img src="../assets/images/app/google-drive.png" width="30" alt="">
											  </div>
											  <div class="app-name">
												  <p class="mb-0 mt-1">IT COLLEGE</p>
											  </div>
											  </div>
											</a>
										 </div>
										 <div class="col">
										  <a href="RoririSoftware/coordinator.php">
											<div class="app-box text-center">
											  ...
											  <div class="app-name">
												  <p class="mb-0 mt-1">COORDINSTOR</p>
											  </div>
											  </div>
											</a>
										 </div>
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="user-info">
								 <p class="user-name mb-0"><?php   echo "User Name"  ?></p>
								<p class="designattion mb-0"><?php  echo "Admin"  ?></p> 
							</div>
						</a>
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
        navigator.mediaDevices.getUserMedia({ video: true })
            ...
            .catch(function(err) {
                ...
                alert("Could not access the camera. Please ensure it's available and you have given permission.");
            });
    } else {
        alert("Your browser does not support camera access or the page is not served over HTTPS.");
    }
});
