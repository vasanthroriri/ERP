...
<style>
		...
		<div class="page-wrapper">
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <h2 class="page-title">Contacts Report</h2>
    ...
    <div class="row mb-3">
        ...
        <div id="loading">Loading Contacts data, please wait...</div>
				<div class="card">
					<div class="card-body">
...
function loadAttendanceData() {
    ...
    fetch('https://treasurebackend.roririsoft.com/forms/nexgen/college/detail/list/')
